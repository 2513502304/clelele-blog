...
export const uiStrings: UIStrings = {
  ...
  'gallery.description':
    '参考画像から抽出した、GPT-Image2、Nano Banana、PixAI、Midjourney、Flux 向けの再利用可能な中国語画像スタイル prompt を集めた個人アーカイブです。',
  'gallery.items': 'style prompts',
  'gallery.prompt': 'Prompt',
  'gallery.examples': 'Generated examples',
  'gallery.subGallery': 'Sub-gallery',
  'gallery.imageIndex': '画像インデックス',
  'gallery.imageMatrix': 'Gallery 画像マトリクス',
  ...
  'gallery.copy': 'コピー',
  'gallery.copied': 'コピー済み',
  'gallery.copyRetry': '再試行',
  'gallery.view': '詳細を見る',
  'gallery.noMatches': '現在の条件に一致するスタイルプロンプトはありません。',
  'gallery.examplesOverviewTitle': 'Sub-gallery 一覧',
  'gallery.subGalleryDescription': 'すべての生成例を、生成プラットフォームと元のスタイルプロンプトとともに閲覧できます。',
  'gallery.examplesSearchPlaceholder': '元のスタイルプロンプトまたはメモを検索...',
  'gallery.examplesPlatform': '生成プラットフォーム',
  ...
  'image.rotate': '90度に回転',
  'image.zoomSensitivity': 'ズーム感度',
  'image.zoomSensitivitySlow': 'ゆるやか',
  'image.zoomSensitivityFast': '高感度',
  'image.close': '閉じる',
  'image.prev': '前へ',
  'image.next': '次へ',
  ...
  'bangumi.retry': '再試行',
  'bangumi.sortBy': '並び順',
  'bangumi.sortDefault': 'デフォルト順',
  'bangumi.sortTitle': '作品名',
  'bangumi.sortPersonalScore': '個人評価',
  'bangumi.sortAverageScore': '平均評価',
  'bangumi.sortDate': '公開日',
  'bangumi.sortAscending': '昇順',
  'bangumi.sortDescending': '降順',
  'bangumi.personalScore': '個人評価',
  'bangumi.averageScore': '平均評価',
  'bangumi.episodeCount': '{count} 話',
  'bangumi.volumeCount': '{count} 巻',
  'bangumi.rank': '順位 {rank}',
  'bangumi.collectionTotal': '{count} 人が登録',
  'bangumi.source': 'Bangumiのデータ',
  ...
  'hpoi.sortBy': '並び順',
  'hpoi.sortDefault': '既定の順序',
  'hpoi.sortId': 'Hpoi ID',
  'hpoi.sortTitle': 'フィギュア名',
  'hpoi.sortScore': '評価',
  'hpoi.sortReleaseDate': '発売日',
  'hpoi.sortAscending': '昇順',
