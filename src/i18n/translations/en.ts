...
export const uiStrings: UIStrings = {
  ...
  'gallery.promptModelUnknown': 'Unknown model',
  'gallery.promptChooserTitle': 'Choose a prompt to copy',
  'gallery.promptChooserDescription': 'Results are grouped by model, with multiple distinct prompts allowed per model.',
  'gallery.promptLoading': 'Loading prompts...',
  'gallery.promptLoadFailed': 'Failed to load prompts. Please retry.',
  'gallery.originalPrompt': 'Original user prompt',
  ...
  'gallery.searchPlaceholder': 'Search text or #tag1 #tag2; #null for untagged…',
  'gallery.indexSearchPlaceholder': 'Search text or #tag1 #tag2; #null for untagged…',
  ...
  'gallery.dateFilter': 'Filter by date',
  'gallery.allDates': 'All dates',
  'gallery.startDate': 'Start time',
  'gallery.endDate': 'End time',
  'gallery.today': 'Today',
  'gallery.lastDay': 'Last 24 hours',
  'gallery.lastDays': 'Last {days} days',
  ...
  'gallery.noItemsOnDate': 'No images on this date',
  'gallery.visualFilter': 'Visual filter',
  'gallery.visualImageTab': 'Search by image',
  'gallery.visualPaletteTab': 'Palette',
  'gallery.visualChooseImage': 'Choose a query image',
  'gallery.visualPasteImageHint': 'Hover and press Ctrl/Cmd + V to paste',
  'gallery.visualUnsupportedImage': 'Clipboard images must be PNG, JPEG, or WebP.',
  'gallery.visualCombined': 'Combined',
  'gallery.visualCombinedHelp': 'Combines scene semantics, near-duplicate structure, and dominant colors.',
  'gallery.visualNearDuplicate': 'Near duplicate',
  'gallery.visualNearDuplicateHelp': 'Finds resized, compressed, transcoded, or lightly cropped versions of the same image.',
  'gallery.visualSemantic': 'Similar content',
  'gallery.visualSemanticHelp': 'Finds similar characters, objects, and scenes even when the image itself is different.',
  'gallery.visualRange': 'Match range',
  'gallery.visualRangePrecise': 'Precise',
  'gallery.visualRangeBroad': 'Broad',
  'gallery.visualRangeHelp': 'A broader range recalls more images with potentially larger differences. 20% is recommended.',
  'gallery.visualSearch': 'Apply filter',
  'gallery.visualSearching': 'Analyzing',
  'gallery.visualReset': 'Clear filter',
  'gallery.visualMatches': '{count} results',
  'gallery.visualFailed': 'Visual search failed. Please retry.',
  ...
  'gallery.examplesSearchPlaceholder': 'Search text or #tag1 #tag2; #null for untagged…',
  ...
  'live2d.previous': 'Previous character costume',
  'live2d.next': 'Next character costume',
  'live2d.characters': 'Characters and costumes',
  'live2d.animations': 'Motions and expressions',
  'live2d.settings': 'Live2D settings',
  'live2d.restore': 'Reset position',
  'live2d.close': 'Close panel',
  'live2d.loading': 'Loading character…',
  'live2d.ready': '{name} is ready',
  'live2d.failed': 'Character failed to load',
  'live2d.retry': 'Retry',
  'live2d.audio': 'Character voice',
  'live2d.audioDescription': 'Play the matching Japanese voice on interaction',
  'live2d.pointerTracking': 'Gaze tracking',
  'live2d.pointerTrackingDescription': 'Follow the pointer, or face forward when disabled',
  ...
  'live2d.position': 'Quick position',
  'live2d.nudge': 'Nudge position',
  'live2d.up': 'Move up',
  'live2d.right': 'Move right',
  'live2d.down': 'Move down',
  'live2d.left': 'Move left',
  'live2d.bottomLeft': 'Bottom left',
  'live2d.bottomCenter': 'Bottom center',
  'live2d.bottomRight': 'Bottom right',
  'live2d.search': 'Search characters or costumes',
  'live2d.searchPlaceholder': 'Search characters or costumes…',
  'live2d.costumeCount': '{count} costumes',
  'live2d.noResults': 'No matching characters or costumes.',
  'live2d.playbackTools': 'Animation tools',
  'live2d.pause': 'Pause',
  'live2d.resume': 'Resume',
  'live2d.screenshot': 'Capture',
  'live2d.motion': 'Motion',
  'live2d.playMotion': 'Play motion',
  'live2d.randomMotion': 'Random motion',
  'live2d.defaultMotion': 'Default motion',
  'live2d.expression': 'Expression',
  'live2d.defaultExpression': 'Default expression',
  'live2d.randomExpression': 'Random expression',
  'live2d.unavailable': 'Unavailable for this model',
  'live2d.automaticEffects': 'Automatic effects',
  'live2d.sway': 'Sway',
  'live2d.breathe': 'Breathe',
  'live2d.blink': 'Blink',
  'live2d.pagination': 'Character and costume pages',
  'live2d.previousPage': 'Previous page',
  'live2d.nextPage': 'Next page',
  'live2d.pageStatus': 'Page {current} of {total}',
  ...
  'image.copyPrompt': 'Copy prompt template',
  'image.copiedPrompt': 'Prompt copied',
  'image.copyFailed': 'Copy failed, retry',
  'image.deleteImage': 'Delete generated image',
  'image.deletingImage': 'Deleting image',
