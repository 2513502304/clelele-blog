...
export const uiStrings = {
  ...
  'gallery.subGallery': 'Sub-gallery 总览',
  'gallery.imageIndex': '图片索引',
  'gallery.imageMatrix': 'Gallery 图片矩阵',
  ...
  'gallery.view': '查看详情',
  'gallery.noMatches': '没有符合当前筛选条件的风格提示词。',
  'gallery.examplesOverviewTitle': 'Sub-gallery 总览',
  'gallery.subGalleryDescription': '集中浏览所有生成示例，并查看每张图片所属的平台和原风格提示词。',
  'gallery.examplesSearchPlaceholder': '搜索来源风格提示词或备注...',
  'gallery.examplesPlatform': '生成平台',
  ...
  'bangumi.averageScore': '平均评分',
  'bangumi.episodeCount': '{count} 话',
  'bangumi.volumeCount': '{count} 卷',
  'bangumi.rank': '排名 {rank}',
  'bangumi.collectionTotal': '{count} 人收藏',
  'bangumi.source': '数据来自 Bangumi',
  ...
  'hpoi.sortBy': '排序方式',
  'hpoi.sortDefault': '默认顺序',
  'hpoi.sortId': 'Hpoi ID',
  'hpoi.sortTitle': '手办名称',
  'hpoi.sortScore': '手办评分',
  'hpoi.sortReleaseDate': '出荷日期',
  'hpoi.sortAscending': '正序',
